...
public class EmpleadoController {
    ...
    ResponseEntity<List<EmpleadoResponseDTO>> listarTodos(@RequestParam(required = false) Integer dniIgual,
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN','GERENTE')")
    ResponseEntity<EmpleadoResponseDTO> actualizar(@PathVariable UUID id, @Valid  @RequestBody EmpleadoUpdateDTO dto){
