...
@Repository
public interface SombrillaRepositorio extends JpaRepository<SombrillaEntity, Long>,
        JpaSpecificationExecutor<SombrillaEntity> {
    Optional<SombrillaEntity> findByPublicId(UUID id);
