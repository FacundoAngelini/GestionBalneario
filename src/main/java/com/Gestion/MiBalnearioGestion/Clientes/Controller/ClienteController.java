...
public class ClienteController {
    ...
    public ResponseEntity<ClienteResponse> actualizarCliente(@PathVariable UUID id,
    ...
    @PreAuthorize("hasRole('ADMIN') or @securityService.esElPropioCliente(#id)")
    ResponseEntity<Void> cambiarNombreUsuario(@PathVariable UUID id,
    ...
    ResponseEntity<Void> cambiarContrasenia(@PathVariable UUID id,
